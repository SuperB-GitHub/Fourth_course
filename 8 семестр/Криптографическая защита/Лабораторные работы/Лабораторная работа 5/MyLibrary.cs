...
namespace MyLibrary
{
    ...
    public static class MathUtils
    {
        ...
        //public static bool TestMillerRabin(long n)
        //{
        ...
        public static bool TestMillerRabin(long n, int k = 3)
        {
            if (n < 2) return false;
    ...
    public static class StringUtils
    {
        ...
        public static List<long> InputList(string startMess = "", string errMess = "Некорректный ввод. Введите целые числа: ", string finalMess = "", int checkId = 0, int expectedCount = 0)
        {
