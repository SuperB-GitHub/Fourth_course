            ...
            if (IsPrime(m))
            {
                ...
                switch (answer)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        Console.WriteLine($"\n\nТ.к. ({a}/{m}) = {answer}, следовательно {a} - квадратичный вычет по mod {m}, т.е. сравнение 2ой степени разрешимо");
                        break;
                    case -1:
                        Console.WriteLine($"\n\nТ.к. ({a}/{m}) = {answer}, следовательно {a} - квадратичный невычет по mod {m}, т.е. сравнение 2ой степени не разрешимо");
                        break;
                }
            }
            else
